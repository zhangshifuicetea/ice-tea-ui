...
import {createScopedClasses, prefix} from '../../utils/classes';
    ...
    useUpdate(expanded, () => {
        ...
        if (expanded) {
            ...
            const afterExpand = () => {
                ...
                divRef.current.classList.add(`${prefix}-tree-children-present`);
            ...
            const afterCollapse = () => {
                if (!divRef.current) {return;}
                divRef.current.style.height = '';
                divRef.current.classList.add(`${prefix}-tree-children-gone`);
